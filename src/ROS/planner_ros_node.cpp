...
private:
    ...
    void pointCloudCallback(const pcl::PointCloud<pcl::PointXYZ>::ConstPtr &_points)
    {
        ...
        // Print number of points in the incoming pointcloud
        ROS_INFO("PointCloud received: %lu points", (unsigned long)_points->points.size());
    ...
    void configureAlgorithm(const std::string &algorithm_name, const std::string &_heuristic){
        ...
        }else if( algorithm_name == "astarmanhattan" ){
            ROS_INFO("Using A*-Manhattan");
            algorithm_.reset(new Planners::AStar_Manhattan(use3d_));
        }else if( algorithm_name == "costastar" ){
            ROS_INFO("Using Cost Aware A*");
            algorithm_.reset(new Planners::AStarM1(use3d_));
        }else if( algorithm_name == "costastar_manhattan" ){
            ROS_INFO("Using Cost Aware A* Manhattan");
            algorithm_.reset(new Planners::AStarM1_Manhattan(use3d_));
        ...
        }else if ( algorithm_name == "thetastar_manhattan" ){
            ROS_INFO("Using Theta* Manhattan");
            algorithm_.reset(new Planners::ThetaStar_Manhattan(use3d_));
        ...
        }else if( algorithm_name == "lazythetastar_manhattan" ){
            ROS_INFO("Using LazyTheta* Manhattan");
            algorithm_.reset(new Planners::LazyThetaStar_Manhattan(use3d_));
        ...
        }else if( algorithm_name == "lazythetastarM2_manhattan"){
            ROS_INFO("Using LazyTheta* M2 Manhattan");
            algorithm_.reset(new Planners::LazyThetaStarM2_Manhattan(use3d_));
