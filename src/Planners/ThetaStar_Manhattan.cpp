#include "Planners/ThetaStar_Manhattan.hpp"

namespace Planners
{
    ThetaStar_Manhattan::ThetaStar_Manhattan(bool _use_3d):AStar_Manhattan(_use_3d, "thetastar_manhattan") {}
    
    ThetaStar_Manhattan::ThetaStar_Manhattan(bool _use_3d, std::string _name = "thetastar_manhattan" ):AStar_Manhattan(_use_3d, _name) {
    ...
    inline void ThetaStar_Manhattan::UpdateVertex(Node *_s, Node *_s2, node_by_position &_index_by_pos)
    {
    ...
    inline void ThetaStar_Manhattan::ComputeCost(Node *_s_aux, Node *_s2_aux)
    {
        // auto distanceParent2 = geometry::distanceBetween2Nodes(_s_aux->parent, _s2_aux);
        line_of_sight_checks_++;
        if ( LineOfSight::bresenham3D_Man(_s_aux->parent, _s2_aux, discrete_world_, checked_nodes) )
        {
            auto distanceParent2 = geometry::distanceBetween2Nodes_Man(_s_aux->parent, _s2_aux); // It should be here--> more efficient
            ...
            auto distance2 = geometry::distanceBetween2Nodes_Man(_s_aux, _s2_aux);
    ...
    void ThetaStar_Manhattan::exploreNeighbours(Node* _current, const Vec3i &_target,node_by_position &_index_by_pos){
    ...
    void ThetaStar_Manhattan::exploreNeighbours_Gradient(Node* _current, const Vec3i &_target,node_by_position &_index_by_pos){
    ...
    int ThetaStar_Manhattan::chooseNeighbours(float angh, float angv){
