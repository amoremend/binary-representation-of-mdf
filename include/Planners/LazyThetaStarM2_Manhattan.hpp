#ifndef LAZYTHETASTARM2_Manhattan_HPP
#define LAZYTHETASTARM2_Manhattan_HPP
/**
 * @file LazyThetaStarM2_Manhattan.hpp
...
namespace Planners
{
     ...
     * 
     */
    class LazyThetaStarM2_Manhattan : public ThetaStarM2
    {
    ...
    public:
         ...
         * 
         */
        LazyThetaStarM2_Manhattan(bool _use_3d, std::string _name );
         ...
         * @param _use_3d 
         */
        LazyThetaStarM2_Manhattan(bool _use_3d);
