#ifndef THETASTAR_MANHATTAN_HPP
#define THETASTAR_MANHATTAN_HPP
/**
 * @file ThetaStar.hpp
...
namespace Planners
{
     ...
     * 
     */
    class ThetaStar_Manhattan : public AStar_Manhattan
    {
    ...
    public:
         ...
         */
        ThetaStar_Manhattan(bool _use_3d, std::string _name );
         ...
         * @param _use_3d 
         */
        ThetaStar_Manhattan(bool _use_3d);
