#ifndef LAZYTHETASTAR_MANHATTAN_HPP
#define LAZYTHETASTAR_MANHATTAN_HPP
/**
...
namespace Planners
{
     ...
     * 
     */
    class LazyThetaStar_Manhattan : public ThetaStar_Manhattan
    {
    ...
    public:
         ...
         * 
         */
        LazyThetaStar_Manhattan(bool _use_3d, std::string _name );
         ...
         * @param _use_3d 
         */
        LazyThetaStar_Manhattan(bool _use_3d);
