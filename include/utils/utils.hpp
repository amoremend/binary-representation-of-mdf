...
namespace Planners
{
    namespace utils
    {
        ...
        static constexpr int const dd_2D_manhattan{static_cast<int>( dist_scale_factor_ * 2 )}; //2
        static constexpr int const dd_3D_manhattan{static_cast<int>( dist_scale_factor_ * 3 )}; //3
